...
VECTOR_PARAMs_in_NTuple (OUTNTUPLE, Int_t, gen_tau_final_pdgIds)
VECTOR_PARAMs_in_NTuple (OUTNTUPLE, Int_t, gen_tau_final_statuses)
VECTOR_OBJECTs_in_NTuple(OUTNTUPLE, std::vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >>, gen_tau_final_p4s)
...
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Int_t, tau_SV_fit_track_SS_matched_track)
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Int_t, tau_SV_fit_track_OS1_matched_track)
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Int_t, tau_SV_fit_track_OS2_matched_track)
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, tau_SV_fit_track_SS_matched_track_dR)
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, tau_SV_fit_track_OS1_matched_track_dR)
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, tau_SV_fit_track_OS2_matched_track_dR)
...
// TRACKS
VECTOR_OBJECTs_in_NTuple(OUTNTUPLE, std::vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> >>, track_p4)
// for check
//VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, track_eta)
//VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, track_phi)
//VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Float_t, track_pt)

VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Int_t, track_vertex_key) // refered vertex
VECTOR_PARAMs_in_NTuple(OUTNTUPLE, Int_t, track_vertex_association) // quality of association
/*
 * association codes:
 * 7 -- was in tight PV fit
 * 5 -- was in loose PV fit
 * ...
 */
