...
input_files, isMC, dtag, dataset_reco_name = ('file:/eos/user/o/otoldaie/test-data-files/Data_SingleElectron_Run2016G_17Jul2018-v1_MINIAOD_50000_02DC57F5-A48B-E811-A98E-0CC47AF9B496.root',) , False, 'Data_SingleElectron_Run2016G_legacy', '2016legacy'

input_files, isMC, dtag, dataset_reco_name = ('file:/afs/cern.ch/user/o/otoldaie/work/public/CMSSW_9_4_9/src/UserCode/NtuplerAnalyzer/Data_SingleMuon_Run2017D_31Mar2018-v1_MINIAOD_80000_1E703527-F436-E811-80A7-E0DB55FC1055.root',)     , False, 'Data_SingleMuon_Run2017D_legacy'    , '2017legacy'

# //dcache-cms-dcap.desy.de//pnfs/desy.de/cms/tier2/store/data/Run2017D/SingleElectron/MINIAOD/31Mar2018-v1/80000/9E6F027F-FD38-E811-A778-0CC47A4D764A.root

input_files, isMC, dtag, dataset_reco_name = ('file:/eos/user/o/otoldaie/test-data-files/Data_SingleMuon_Run2017D_31Mar2018-v1_MINIAOD_80000_1E703527-F436-E811-80A7-E0DB55FC1055.root',)     , False, 'Data_SingleMuon_Run2017D_legacy'    , '2017legacy'

input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIIFall17MiniAODv2_PU2017_12Apr2018_94X_mc2017_realistic_v14-v1_MINIAODSIM_00000_523E450B-CB41-E811-AACA-001E6739B849.root',), True, 'MC_TTJets_2017legacy_TTTo2L_test_genDistrs'

input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8_RunIIFall17MiniAODv2_PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_D8FD945E-5588-E811-A866-D8D385FF33B9.root',), True, 'MC_WJets_2017legacy_test_genDistrs'


# the recommended electron ID is not available
#input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_RunIIFall17MiniAOD_94X_mc2017_realistic_v10-v1_MINIAODSIM_60000_A870C1FB-F7DE-E711-ADE3-002590E39D8A.root',), True, 'MC_TTJets_2017legacy_TTToSemileptonic_Dmesons'
input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_70000_66196F80-1659-E811-9076-008CFAEBDC00.root',), True, 'MC_TTJets_2017legacy_TTToSemileptonic_Dmesons'
input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIIFall17MiniAODv2_PU2017_12Apr2018_94X_mc2017_realistic_v14-v1_MINIAODSIM_00000_523E450B-CB41-E811-AACA-001E6739B849.root',), True, 'MC_TTJets_2017legacy_TTTo2L_Dmesons'

input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_84BC6294-1659-E811-87F9-008CFAC93FDC.root',), True, 'MC_TTJets_2017legacy_TTToSemileptonic_Dmesons_2'

input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/SingleElectron_Run2017E-31Mar2018-v1_MINIAOD_90000_24DC3796-C338-E811-BA7E-00266CFFBEB4.root',), False, 'Data_2017_SingleElectron_Run2017E-31Mar2018-v1_00266CFFBEB4_Dmesons_3'
input_files, isMC, dtag = ('file:/eos/user/o/otoldaie/test-data-files/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v2_MINIAODSIM_6E62B895-1659-E811-9241-008CFAC93E1C.root',), True, 'MC_TTJets_2017legacy_TTToSemileptonic_Dmesons_3'
...
process.ntupler.jet_kino_cuts_pt  = cms.double( 10.)
print process.ntupler.jet_kino_cuts_pt
...
# now the taus saved from the collection under the name process.ntupler.tau_objs_name
# must have both new MVA and DeepTau IDs available

print 'DeepTau SET', dataset_reco_name, process.ntupler.tau_objs_name
...
## inclusive triggers to cover 2017legacy
## TODO: find 2017legacy triggers -- testing, supposedly the triggers are ok now
