...
input_files, isMC, dtag = ('root://eoscms//eos////user/o/otoldaie/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_D4F3B681-A3BE-E611-913C-0CC47AC08816.root',), True, 'TTJets'
...
output_file = '/afs/cern.ch/work/o/otoldaie/private/16/CMSSW_8_0_26_patch1/src/UserCode/NtuplerAnalyzer/TauMatch_test.root'
...
# for LumiDump:
process.tauMatch.input = cms.untracked.vstring(input_files)
process.tauMatch.outfile = cms.string(output_file)
