...
namespace patUtils
{
  ...
  bool passId(pat::Electron& el,  reco::Vertex& vtx, int IdLevel, int cutVersion){
	...
	case CutVersion::Legacy2017_94X_Fall17v1 :
		...
		// /eos/user/o/otoldaie/test-data-files/TTToSemiLeptonic_TuneCP5_PSweights_13TeV-powheg-pythia8_RunIIFall17MiniAOD_94X_mc2017_realistic_v10-v1_MINIAODSIM_60000_A870C1FB-F7DE-E711-ADE3-002590E39D8A.root
