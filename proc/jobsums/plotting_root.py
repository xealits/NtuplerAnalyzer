...
"tt_mutau":      {'color': rgb(255, 255, 178), 'legend': 't#bar{t}#rightarrow #bf{#mu}#nu #tau_{h}#nu b#bar{b}'},
"tt_eltau":      {'color': rgb(254,204,92),    'legend': 't#bar{t}#rightarrow e#nu #tau_{h}#nu b#bar{b}'},
"tt_elmu":       {'color': rgb(254,224,210),   'legend': 't#bar{t}#rightarrow e#nu #mu#nu b#bar{b}'},
