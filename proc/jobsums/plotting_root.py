...
"s_top":       {'color': kAzure+6, 'legend': 'Single t quark'},
...
"tt_ltaul":      {'color': rgb(210,146,114),   'legend': 't#bar{t}#rightarrowl#tau_{l}'},
"tt_taueltaumu": {'color': rgb(255,120,60),    'legend': 't#bar{t}#rightarrow#tau_{e}#tau_{#mu}'},
"tt_ljw":        {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrowljw'},
"tt_ljb":        {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrowljb'},
"tt_ljo":        {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrowljo'},
"tt_lj":         {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrowl#nu_{l}qq\'b#bar{b}'},
"tt_muj":        {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrow#mu#nu_{#mu}qq\'b#bar{b}'},
"tt_elj":        {'color': rgb(240,59,32),     'legend': 't#bar{t}#rightarrowe#nu_{e}qq\'b#bar{b}'},
"tt_taulj":      {'color': rgb(210,29,32),     'legend': 't#bar{t}#rightarrow#tau_{l}j'},
"tt_other":      {'color': rgb(189,0,38),      'legend': 't#bar{t}#rightarrowother'},
"tt_else":       {'color': rgb(189,0,38),      'legend': 't#bar{t}#rightarrowother'},
