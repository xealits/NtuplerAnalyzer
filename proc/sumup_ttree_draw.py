...
all_std_channels = {
'mu_sel':          '({selection_stage}==109 || {selection_stage}==107)',
'mu_sel_ss':       '({selection_stage}==108 || {selection_stage}==106)',
'el_sel':          '({selection_stage}==119 || {selection_stage}==117)',
'el_sel_ss':       '({selection_stage}==118 || {selection_stage}==116)',
'mu_selVloose':    '({selection_stage}==109 || {selection_stage}==107 || {selection_stage}==105)',
'mu_selVloose_ss': '({selection_stage}==108 || {selection_stage}==106 || {selection_stage}==104)',
'el_selVloose':    '({selection_stage}==119 || {selection_stage}==117 || {selection_stage}==115)',
'el_selVloose_ss': '({selection_stage}==118 || {selection_stage}==116 || {selection_stage}==114)',

'mu_sel_ljout':          '({selection_stage}==109 || {selection_stage}==107) && event_jets_lj_var >  60.',
'mu_sel_ljout_ss':       '({selection_stage}==108 || {selection_stage}==106) && event_jets_lj_var >  60.',
'el_sel_ljout':          '({selection_stage}==119 || {selection_stage}==117) && event_jets_lj_var >  60.',
'el_sel_ljout_ss':       '({selection_stage}==118 || {selection_stage}==116) && event_jets_lj_var >  60.',
'mu_selVloose_ljout':    '({selection_stage}==109 || {selection_stage}==107 || {selection_stage}==105) && event_jets_lj_var >  60.',
'mu_selVloose_ljout_ss': '({selection_stage}==108 || {selection_stage}==106 || {selection_stage}==104) && event_jets_lj_var >  60.',
'el_selVloose_ljout':    '({selection_stage}==119 || {selection_stage}==117 || {selection_stage}==115) && event_jets_lj_var >  60.',
'el_selVloose_ljout_ss': '({selection_stage}==118 || {selection_stage}==116 || {selection_stage}==114) && event_jets_lj_var >  60.',

'mu_sel_lj':          '({selection_stage}==109 || {selection_stage}==107) && event_jets_lj_var <= 60.',
'mu_sel_lj_ss':       '({selection_stage}==108 || {selection_stage}==106) && event_jets_lj_var <= 60.',
'el_sel_lj':          '({selection_stage}==119 || {selection_stage}==117) && event_jets_lj_var <= 60.',
'el_sel_lj_ss':       '({selection_stage}==118 || {selection_stage}==116) && event_jets_lj_var <= 60.',
'mu_selVloose_lj':    '({selection_stage}==109 || {selection_stage}==107 || {selection_stage}==105) && event_jets_lj_var <= 60.',
'mu_selVloose_lj_ss': '({selection_stage}==108 || {selection_stage}==106 || {selection_stage}==104) && event_jets_lj_var <= 60.',
'el_selVloose_lj':    '({selection_stage}==119 || {selection_stage}==117 || {selection_stage}==115) && event_jets_lj_var <= 60.',
'el_selVloose_lj_ss': '({selection_stage}==118 || {selection_stage}==116 || {selection_stage}==114) && event_jets_lj_var <= 60.',
